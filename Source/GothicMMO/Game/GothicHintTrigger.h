...
//
// Fires once by default and then does nothing forever. The hint manager's
// seen-set would already swallow a repeat, but a trigger that keeps overlapping
// keeps doing work and keeps writing log lines for a hint that will never show.
//

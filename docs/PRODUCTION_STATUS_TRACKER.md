...
*Last updated: July 2026 — update this document's date whenever it's revised*
...
| Item | Status | Notes |
|---|---|---|
| Warden — identity, creed mapping, Prior Flame expression | 🔴 | Locked in lore, zero kit/ability design |
| Warden — ability kit | ⚪ | Not yet designed |
| Penitent — identity, creed mapping, Prior Flame expression | 🔴 | Locked in lore, zero kit/ability design |
| Penitent — ability kit | ⚪ | Not yet designed |
...
3. **Selah collection UI + Steadfast implementation** — both fully designed, both required for the loop to feel complete rather than just functional
4. **Death/failure state implementation (Contract-scale)** — fully designed, closes the last major "this doesn't exist yet and other systems assume it does" gap
5. **Playtest with a person who isn't you** — the actual validation gate; everything above this line is prerequisite to this being meaningful

Everything below this line (Warden kit, economy implementation, progression systems, raid design) is **correctly deferred** — not neglected, not forgotten, just genuinely lower priority than closing the loop between "fully designed" and "fully playable" for what already exists.
